    ...
    <>
      <section className="bg-gradient-to-b from-primary-light via-primary-bg to-white py-20 text-center">
        <div className="max-w-[1200px] mx-auto px-6">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">How Does MyyShop Compare?</h1>
            ...
            {comparisonList.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`bg-white border border-gray-200 rounded-2xl p-8 transition-all ${hasDetail ? 'hover:border-primary hover:shadow-[0_12px_40px_rgba(58,163,159,0.1)]' : 'opacity-60'}`}
                >
