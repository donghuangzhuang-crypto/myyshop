...
import { creatorProducts, resourceLinks } from '@/content/navigation';
      ...
      <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            {/* Brand Products */}
            <Link href="#" className="text-sm font-medium text-dark hover:text-primary hover:bg-primary-bg-light px-3.5 py-2 rounded-lg transition-colors">
              Brand Products
            </Link>
